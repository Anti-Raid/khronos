...
impl<T: KhronosContext> LuaUserData for ScheduledExecExecutor<T> {
    ...
    fn add_methods<M: LuaUserDataMethods<Self>>(methods: &mut M) {
        methods.add_promise_method("list", async move |lua, this, (id,): (Option<String>,)| {
        ...
        methods.add_promise_method("add", async move |lua, this, (data,): (LuaValue,)| {
        ...
        methods.add_promise_method("remove", async move |_, this, id: String| {
