...
impl<T: KhronosContext> LuaUserData for ScheduledExecExecutor<T> {
    ...
    fn add_methods<M: LuaUserDataMethods<Self>>(methods: &mut M) {
        methods.add_scheduler_async_method(
            "list",
            async move |lua, this, (id,): (Option<String>,)| {
        ...
        methods.add_scheduler_async_method("add", async move |lua, this, (data,): (LuaValue,)| {
            let cse = lua.from_value::<types::CreateScheduledExecution>(data)?;

            this.check_action("add".to_string())?;

            this.scheduled_exec_provider
                .add(crate::traits::ir::ScheduledExecution {
        ...
        methods.add_scheduler_async_method("remove", async move |_, this, id: String| {
